...
<body>
	...
	<div align="center">
	   ...
	   <hr width="50%" color="tomato">
	      <h3>${dto.writer } 님 게시글 상세 내역 페이지</h3>
	   <hr width="50%" color="tomato">
	   <br>
	   ...
	   <table border="1" cellspacing="0" width="400">
	      ...
	      <tr>
	         <th>글내용</th>
	         <td>
	            <textarea rows="7" cols="25" readonly>${dto.content }</textarea>
	         </td>
	      </tr>
	      ...
	      <tr>
	         <td colspan="2" align="center">
	            <input type="button" value="글수정"
	               onclick="location.href='board_modify.do?no=${dto.bno }'">
	         
	            <input type="button" value="글삭제"
	               onclick="location.href='board_remove.do?no=${dto.bno }'">
