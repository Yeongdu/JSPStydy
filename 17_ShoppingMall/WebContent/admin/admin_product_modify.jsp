...
<body>
	...
	<jsp:include page="../include/admin_top.jsp" />
	   ...
	   <form method="post" enctype="multipart/form-data"
	      action="<%=request.getContextPath() %>/admin_product_modify_ok.do">
	      ...
	      <table border="1" cellspacing="0" width="500">
	         <tr>
	            <th>카테고리 코드</th>
	            <td>
	               <input name="p_category" readonly
	                    value="${dto.getPcategory_fk() }">
	            </td>
	         </tr>
	         ...
	         <tr>
	            <th>제조사</th>
	            <td>
	               <input name="p_company" readonly
	                    value="${dto.getPcompany() }">
	            </td>
	         </tr>
	         ...
	         <tr>
	            ...
	            <td>
	               ...
	               <%-- 이미지를 수정하지 않고 그대로 제품수정 버튼을
	                    누르면 상품 등록 때 입력했던 제품의 이미지를
	                    그대로 사용하여 히든으로 넘겨줄 예정. --%>
	         ...
	         <tr>
	            <th>제품 소개</th>
	            <td>
	               <textarea rows="7" cols="25" name="p_content">${dto.getPcontent() }</textarea>
	            </td>
	         </tr>
